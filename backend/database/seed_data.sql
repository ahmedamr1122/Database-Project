...
-- Admin user
('admin', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPjlpK0tU0ZK', 'System', 'Administrator', 'admin@bookstore.com', '+1-555-0100', '123 Admin St, Admin City, AC 12345', 'admin'),

-- Customer users
('john_doe', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPjlpK0tU0ZK', 'John', 'Doe', 'john.doe@email.com', '+1-555-0101', '456 Customer Ave, Customer City, CC 67890', 'customer'),
('jane_smith', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPjlpK0tU0ZK', 'Jane', 'Smith', 'jane.smith@email.com', '+1-555-0102', '789 Reader Blvd, Reader Town, RT 54321', 'customer'),
('bob_wilson', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPjlpK0tU0ZK', 'Bob', 'Wilson', 'bob.wilson@email.com', '+1-555-0103', '321 Book Lover Ln, Book City, BC 98765', 'customer'),
('alice_brown', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPjlpK0tU0ZK', 'Alice', 'Brown', 'alice.brown@email.com', '+1-555-0104', '654 Library Rd, Library Town, LT 13579', 'customer'),
('charlie_davis', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPjlpK0tU0ZK', 'Charlie', 'Davis', 'charlie.davis@email.com', '+1-555-0105', '987 Page Turner St, Page City, PC 24680', 'customer');
...
-- =============================================
INSERT INTO Customer_Orders (user_id, order_date, total_price, credit_card_no, expiry_date) VALUES
(2, '2024-12-01 10:30:00', 44.97, '4111111111111111', '12/26'), -- John Doe order
(3, '2024-12-02 14:20:00', 11.99, '5555555555554444', '08/27'), -- Jane Smith order
(4, '2024-12-03 16:45:00', 29.97, '378282246310005', '05/28'),  -- Bob Wilson order
(5, '2024-12-04 09:15:00', 14.99, '6011111111111117', '11/29'), -- Alice Brown order
(2, '2024-12-05 11:00:00', 15.99, '4111111111111111', '12/26'); -- John Doe second order
